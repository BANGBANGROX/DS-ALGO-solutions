...
public:
    ...
    pair<int, int> sumOfLongRootToLeafPathUtil(Node* root) {
        ...
        if (root->left == NULL && root->right == NULL) return { root->data, 1 };

        pair<int, int> l = sumOfLongRootToLeafPathUtil(root->left);
        pair<int, int> r = sumOfLongRootToLeafPathUtil(root->right);
    ...
    int sumOfLongRootToLeafPath(Node* root) {
        //code here
        pair<int, int> ans = sumOfLongRootToLeafPathUtil(root);
